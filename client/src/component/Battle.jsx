  ...
  return (
    <div className="h-screen bg-gradient-to-tr from-gray-600 to-gray-300">
      ...
      <div className="grid grid-cols-2 gap-4 p-6">
        <div className="cursor-pointer rounded-xl bg-gradient-to-tr from-red-900 to-red-500 duration-300 p-4 ease-in hover:-translate-y-5 hover:drop-shadow-2xl">
        ...
        <div className="cursor-pointer rounded-xl p-4 bg-gradient-to-tr from-red-900 to-red-500 duration-300 ease-in hover:-translate-y-5 hover:drop-shadow-2xl">
          <h1 className="mt-2 flex justify-center text-slate-50">
            {randomOpponent.name}
          </h1>
          <img
